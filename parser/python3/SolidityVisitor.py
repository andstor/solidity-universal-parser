...
class SolidityVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SolidityParser#spdxLicenseIdentifier.
    def visitSpdxLicenseIdentifier(self, ctx:SolidityParser.SpdxLicenseIdentifierContext):
        return self.visitChildren(ctx)
    ...
    def visitNatSpec(self, ctx:SolidityParser.NatSpecContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#overrideParameters.
    def visitOverrideParameters(self, ctx:SolidityParser.OverrideParametersContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#objectList.
    def visitObjectList(self, ctx:SolidityParser.ObjectListContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SolidityParser#ifCondition.
    def visitIfCondition(self, ctx:SolidityParser.IfConditionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SolidityParser#ifRight.
    def visitIfRight(self, ctx:SolidityParser.IfRightContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SolidityParser#ifWrong.
    def visitIfWrong(self, ctx:SolidityParser.IfWrongContext):
        return self.visitChildren(ctx)

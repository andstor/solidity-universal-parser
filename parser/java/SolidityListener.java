...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#spdxLicenseIdentifier}.
	 * @param ctx the parse tree
	 */
	void enterSpdxLicenseIdentifier(SolidityParser.SpdxLicenseIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#spdxLicenseIdentifier}.
	 * @param ctx the parse tree
	 */
	void exitSpdxLicenseIdentifier(SolidityParser.SpdxLicenseIdentifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#overrideParameters}.
	 * @param ctx the parse tree
	 */
	void enterOverrideParameters(SolidityParser.OverrideParametersContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#overrideParameters}.
	 * @param ctx the parse tree
	 */
	void exitOverrideParameters(SolidityParser.OverrideParametersContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#objectList}.
	 * @param ctx the parse tree
	 */
	void enterObjectList(SolidityParser.ObjectListContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#objectList}.
	 * @param ctx the parse tree
	 */
	void exitObjectList(SolidityParser.ObjectListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#ifRight}.
	 * @param ctx the parse tree
	 */
	void enterIfRight(SolidityParser.IfRightContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#ifRight}.
	 * @param ctx the parse tree
	 */
	void exitIfRight(SolidityParser.IfRightContext ctx);
	/**
	 * Enter a parse tree produced by {@link SolidityParser#ifWrong}.
	 * @param ctx the parse tree
	 */
	void enterIfWrong(SolidityParser.IfWrongContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#ifWrong}.
	 * @param ctx the parse tree
	 */
	void exitIfWrong(SolidityParser.IfWrongContext ctx);
	/**
